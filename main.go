...
import (
	...
	"github.com/tahsinrahman/online-judge/application"
...
func newConfig() (*viper.Viper, error) {
	defaultDSN := strings.Replace("root:@tcp(localhost:3306)/online-judge?parseTime=true", "-", "_", -1)

	c := viper.New()
	c.SetDefault("dsn", defaultDSN)
	c.SetDefault("cookie_secret", "Vdu0fUTubg8sP68i")
